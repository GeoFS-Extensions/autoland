...
var GetStorageSyncData = function (name) {
...
var getOptions = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, GetStorageSyncData('options').then(function (val) {
                    data = val.options;
                })];
            case 1:
                _a.sent();
...
var getButtons = function () {
    var buttons = emptyButtons();
    Object.keys(buttons).forEach(function (key) {
        buttons[key] = document.querySelector("#" + key + "button");
    });
    return buttons;
};
var UpdateButtons = function (buttons, options) {
    Object.keys(buttons).forEach(function (key) {
        if (options[key]) {
            ...
            case 1:
                ...
                Object.keys(buttons).forEach(function (key) {
                    buttons[key].addEventListener('click', function () {
                        var _a;
                        options = setOptions(__assign(__assign({}, options), (_a = {}, _a[key] = !options[key], _a))); // works until we add sound
                        UpdateButtons(buttons, options);
                    });
                });
                return [2 /*return*/];
