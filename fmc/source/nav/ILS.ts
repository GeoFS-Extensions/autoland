...
define(["flight", "utils", "exports"], function (flight, utils, exports) {
  ...
  // URLs of instruments
  var FILE_PATH = window.PAGE_PATH + "fmc/images/";
  var url = {
  ...
  function glideslopeCalc() {
    ...
    var current = window.geofs.aircraft.instance.llaLocation;

    // If either one component is missing, invalid, returns 0
    if (
      !(threshold[0] && threshold[1] && current[0] && current[1] && current[2])
    )
      return 0;
    ...
    var altitudeAtAim = window.geofs.getGroundAltitude(
      threshold[0],
      threshold[1]
    ); // Feet
    var distanceToAim =
    ...
    overlay: {
      ...
      overlays: [
        // attitude-jet-hand
        {
          ...
          url: window.PAGE_PATH + "images/instruments/attitude-jet-hand.png",
          anchor: {
            x: 100,
            y: 70,
          },
        ...
        // attitude-jet-pointer
        {
          ...
          url: window.PAGE_PATH + "images/instruments/attitude-jet-pointer.png",
          anchor: {
            x: 100,
            y: 100,
          },
