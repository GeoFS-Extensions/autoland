...
define([
  ...
  var autopilot = window.autopilot_pp.require("autopilot"),
    gc = window.autopilot_pp.require("greatcircle"),
  ...
  setInterval(function () {
    llaLocation(window.geofs.aircraft.instance.llaLocation);
  }, 1000);
  ...
  function getInfoFromPrev(self): Array<any> {
    ...
    return [
      Math.round(distance * 10) / 10 || null,
      Math.round(bearing) || null,
    ];
  }
  ...
  function addWaypoint() {
    ...
    if (typeof window.componentHandler === "object")
