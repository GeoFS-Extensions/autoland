...
/* harmony import */ var _autopilot_modes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./autopilot/modes */ "./source/autopilot/modes.ts");
/* harmony import */ var _autopilot_pidcontrols__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./autopilot/pidcontrols */ "./source/autopilot/pidcontrols.ts");
/* harmony import */ var _greatcircle__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./greatcircle */ "./source/greatcircle.ts");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./util */ "./source/util.ts");
...
on.subscribe(function (newValue) {
    ...
    if (!newValue) {
        Object.keys(_autopilot_modes__WEBPACK_IMPORTED_MODULE_1__["default"]).forEach(function (prop) {
            _autopilot_modes__WEBPACK_IMPORTED_MODULE_1__["default"][prop].enabled(false);
        });
    }
});
function toggle() {
...
_autopilot_modes__WEBPACK_IMPORTED_MODULE_1__["default"].heading.enabled.subscribe(function (newValue) {
    if (newValue)
        _autopilot_pidcontrols__WEBPACK_IMPORTED_MODULE_2__["default"].roll.init(controls.roll);
});
_autopilot_modes__WEBPACK_IMPORTED_MODULE_1__["default"].altitude.enabled.subscribe(function (newValue) {
    if (newValue) {
        _autopilot_pidcontrols__WEBPACK_IMPORTED_MODULE_2__["default"].climb.init(geofs.aircraft.instance.animationValue.atilt);
        _autopilot_pidcontrols__WEBPACK_IMPORTED_MODULE_2__["default"].pitch.init(_util__WEBPACK_IMPORTED_MODULE_4__["default"].clamp(controls.pitch, -1, 1));
...
_autopilot_modes__WEBPACK_IMPORTED_MODULE_1__["default"].heading.enabled.subscribe(function (newValue) {
    if (newValue)
        _autopilot_pidcontrols__WEBPACK_IMPORTED_MODULE_2__["default"].throttle.init(controls.throttle);
});
let lastGcHeadingUpdate = 0;
function update(dt) {
    const values = geofs.aircraft.instance.animationValue;
    const speedRatio = _util__WEBPACK_IMPORTED_MODULE_4__["default"].clamp(values.ktas / 100, 0.5, 5);
    ...
    function updateHeading() {
        if (ap.currentMode() !== 0 &&
            ...
            const headingToDest = _greatcircle__WEBPACK_IMPORTED_MODULE_3__["default"].getHeading();
            if (isFinite(headingToDest))
                _autopilot_modes__WEBPACK_IMPORTED_MODULE_1__["default"].heading.value(Math.round(headingToDest));
            lastGcHeadingUpdate = performance.now();
        }
        const deltaHeading = _util__WEBPACK_IMPORTED_MODULE_4__["default"].fixAngle(_autopilot_modes__WEBPACK_IMPORTED_MODULE_1__["default"].heading.value() - values.heading);
        const maxBankAngle = Math.min(_util__WEBPACK_IMPORTED_MODULE_4__["default"].rad2deg(Math.atan(0.0027467328927254283 * values.ktas)), ap.maxBankAngle);
        const targetBankAngle = _util__WEBPACK_IMPORTED_MODULE_4__["default"].clamp(deltaHeading, -maxBankAngle, maxBankAngle);
        const result = _autopilot_pidcontrols__WEBPACK_IMPORTED_MODULE_2__["default"].roll.compute(-values.aroll, dt, targetBankAngle);
        controls.roll = _util__WEBPACK_IMPORTED_MODULE_4__["default"].exponentialSmoothing("apRoll", result / speedRatio, 0.9);
        controls.yaw = _util__WEBPACK_IMPORTED_MODULE_4__["default"].exponentialSmoothing("apYaw", controls.roll / 2, 0.1);
        if (geofs.aircraft.instance.name === "a380")
            controls.roll *= 3.5;
    }
    function updateAltitude() {
        const deltaAltitude = _autopilot_modes__WEBPACK_IMPORTED_MODULE_1__["default"].altitude.value() - values.altitude;
        const maxClimbRate = _util__WEBPACK_IMPORTED_MODULE_4__["default"].clamp(speedRatio * ap.commonClimbRate, 0, ap.maxClimbRate);
        const maxDescentRate = _util__WEBPACK_IMPORTED_MODULE_4__["default"].clamp(speedRatio * ap.commonDescentRate, ap.maxDescentRate, 0);
        const vsValue = _autopilot_modes__WEBPACK_IMPORTED_MODULE_1__["default"].vs.value();
        const manualVsControl = vsValue !== undefined &&
            (vsValue === 0 ||
                (vsValue < 0 ? deltaAltitude < -200 : deltaAltitude > 200));
        if (_autopilot_modes__WEBPACK_IMPORTED_MODULE_1__["default"].vs.enabled()) {
            if (!manualVsControl)
                _autopilot_modes__WEBPACK_IMPORTED_MODULE_1__["default"].vs.enabled(false);
        }
        else if (manualVsControl) {
            _autopilot_modes__WEBPACK_IMPORTED_MODULE_1__["default"].vs.enabled(true);
        }
        let targetClimbRate;
        if (manualVsControl)
            targetClimbRate = vsValue;
        else
            targetClimbRate = _util__WEBPACK_IMPORTED_MODULE_4__["default"].clamp(deltaAltitude * 2.5, maxDescentRate, maxClimbRate);
        let targetTilt = _autopilot_pidcontrols__WEBPACK_IMPORTED_MODULE_2__["default"].climb.compute(values.climbrate, dt, targetClimbRate);
        targetTilt = _util__WEBPACK_IMPORTED_MODULE_4__["default"].clamp(targetTilt, ap.minPitchAngle, ap.maxPitchAngle);
        const result = _autopilot_pidcontrols__WEBPACK_IMPORTED_MODULE_2__["default"].pitch.compute(-values.atilt, dt, targetTilt);
        controls.rawPitch = _util__WEBPACK_IMPORTED_MODULE_4__["default"].exponentialSmoothing("apPitch", result / speedRatio, 0.9);
        geofs.debug.watch("targetClimbrate", targetClimbRate);
        geofs.debug.watch("aTargetTilt", targetTilt);
    }
    function updateThrottle() {
        let speed = _autopilot_modes__WEBPACK_IMPORTED_MODULE_1__["default"].speed.value();
        if (_autopilot_modes__WEBPACK_IMPORTED_MODULE_1__["default"].speed.isMach())
            speed = _autopilot_modes__WEBPACK_IMPORTED_MODULE_1__["default"].speed.toKias(speed);
        const result = _autopilot_pidcontrols__WEBPACK_IMPORTED_MODULE_2__["default"].throttle.compute(values.kcas, dt, speed);
        controls.throttle = _util__WEBPACK_IMPORTED_MODULE_4__["default"].clamp(_util__WEBPACK_IMPORTED_MODULE_4__["default"].exponentialSmoothing("apThrottle", result, 0.9), 0, 1);
        geofs.debug.watch("throttle", controls.throttle);
    }
    if (_autopilot_modes__WEBPACK_IMPORTED_MODULE_1__["default"].heading.enabled())
        updateHeading();
    if (_autopilot_modes__WEBPACK_IMPORTED_MODULE_1__["default"].altitude.enabled())
        updateAltitude();
    if (_autopilot_modes__WEBPACK_IMPORTED_MODULE_1__["default"].speed.enabled())
        updateThrottle();
}
const ap = {
    on,
    toggle,
    update,
    modes: _autopilot_modes__WEBPACK_IMPORTED_MODULE_1__["default"],
    currentMode,
    maxBankAngle: 25,
    minPitchAngle: -10,
    maxPitchAngle: 10,
...
/* harmony import */ var knockout__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! knockout */ "../node_modules/knockout/build/output/knockout-latest.js");
/* harmony import */ var knockout__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(knockout__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _speedconversions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../speedconversions */ "./source/speedconversions.ts");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../util */ "./source/util.ts");
...
function toMach(kias) {
    const altitude = _util__WEBPACK_IMPORTED_MODULE_2__["default"].ft2mtrs(geofs.aircraft.instance.animationValue.altitude);
    return _speedconversions__WEBPACK_IMPORTED_MODULE_1__["default"].casToMach(kias, altitude);
}
function toKias(mach) {
    const altitude = _util__WEBPACK_IMPORTED_MODULE_2__["default"].ft2mtrs(geofs.aircraft.instance.animationValue.altitude);
    return _speedconversions__WEBPACK_IMPORTED_MODULE_1__["default"].machToCas(mach, altitude);
}
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _pid__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../pid */ "./source/pid.ts");

const pidSettings = {
    climb: new _pid__WEBPACK_IMPORTED_MODULE_0__["default"]({
        kp: 0.01,
        ti: 10,
        td: 0.005,
        min: -10,
    ...
    pitch: new _pid__WEBPACK_IMPORTED_MODULE_0__["default"]({
        kp: 0.02,
        ti: 2,
        td: 0.01,
        min: -3,
    ...
    roll: new _pid__WEBPACK_IMPORTED_MODULE_0__["default"]({
        kp: 0.02,
        ti: 100,
        td: 0.01,
        min: -1,
    ...
    throttle: new _pid__WEBPACK_IMPORTED_MODULE_0__["default"]({
        kp: 0.015,
        ti: 2.5,
        td: 0.1,
        min: 0,
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../util */ "./source/util.ts");
...
function papiBugfix() {
    ...
    function setPapi() {
        ...
        const path = _util__WEBPACK_IMPORTED_MODULE_0__["default"].rad2deg(Math.atan2(height, distance));
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _speedconversions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./speedconversions */ "./source/speedconversions.ts");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./util */ "./source/util.ts");


function setKcas() {
    const animationValue = geofs.aircraft.instance.animationValue;
    animationValue.kcas = _speedconversions__WEBPACK_IMPORTED_MODULE_0__["default"].tasToCas(animationValue.ktas, _util__WEBPACK_IMPORTED_MODULE_1__["default"].ft2mtrs(animationValue.altitude));
}
function enableKcas() {
...
function getClosestPoint(list) {
    ...
    return list.reduce(function (closestPoint, point) {
        ...
        const deltaLat = _util__WEBPACK_IMPORTED_MODULE_0__["default"].deg2rad(acLat - point[0]);
        const deltaLon = _util__WEBPACK_IMPORTED_MODULE_0__["default"].deg2rad(acLon - point[1]);
        const meanLat = 0.5 * _util__WEBPACK_IMPORTED_MODULE_0__["default"].deg2rad(acLat + point[0]);
        const x = deltaLat;
...
function getHeading() {
    ...
    const lat1 = _util__WEBPACK_IMPORTED_MODULE_1__["default"].deg2rad(coords[0]);
    const lon1 = _util__WEBPACK_IMPORTED_MODULE_1__["default"].deg2rad(coords[1]);
    const lat2 = _util__WEBPACK_IMPORTED_MODULE_1__["default"].deg2rad(lat());
    const lon2 = _util__WEBPACK_IMPORTED_MODULE_1__["default"].deg2rad(lon());
    if (!isFinite(lat2) || !isFinite(lon2))
        return;
    const heading = _util__WEBPACK_IMPORTED_MODULE_1__["default"].rad2deg(atan2(sin(lon2 - lon1) * cos(lat2), cos(lat1) * sin(lat2) - sin(lat1) * cos(lat2) * cos(lon2 - lon1)));
    return _util__WEBPACK_IMPORTED_MODULE_1__["default"].fixAngle360(heading);
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
    latitude: lat,
    longitude: lon,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AutopilotVM": () => (/* binding */ AutopilotVM),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var knockout__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! knockout */ "../node_modules/knockout/build/output/knockout-latest.js");
/* harmony import */ var knockout__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(knockout__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _greatcircle__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../greatcircle */ "./source/greatcircle.ts");
/* harmony import */ var _autopilot__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../autopilot */ "./source/autopilot.ts");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../util */ "./source/util.ts");
/* harmony import */ var _getwaypoint__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../getwaypoint */ "./source/getwaypoint.ts");
/* harmony import */ var _shouldnthaveap__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../shouldnthaveap */ "./source/shouldnthaveap.ts");
...
class AutopilotVM {
    ...
    validateHeading(val) {
        return _util__WEBPACK_IMPORTED_MODULE_3__["default"].fixAngle360(parseInt(val));
    }
    validateLat(val) {
        return _util__WEBPACK_IMPORTED_MODULE_3__["default"].clamp(parseFloat(val), -90, 90);
    }
    validateLon(val) {
        return _util__WEBPACK_IMPORTED_MODULE_3__["default"].clamp(parseFloat(val), -180, 180);
    }
    toggle = () => {
        if (!_shouldnthaveap__WEBPACK_IMPORTED_MODULE_5__["default"].includes(geofs.aircraft.instance.id)) {
            _autopilot__WEBPACK_IMPORTED_MODULE_2__["default"].toggle();
        }
    };
    nextMode = () => {
        const mode = _autopilot__WEBPACK_IMPORTED_MODULE_2__["default"].currentMode();
        _autopilot__WEBPACK_IMPORTED_MODULE_2__["default"].currentMode(mode === AutopilotVM.modeToText.length - 1 ? 0 : mode + 1);
    };
    static modeToText = [
        "Heading mode",
        "Lat/lon mode",
    ...
    on = _autopilot__WEBPACK_IMPORTED_MODULE_2__["default"].on;
    currentMode = _autopilot__WEBPACK_IMPORTED_MODULE_2__["default"].currentMode;
    currentModeText = knockout__WEBPACK_IMPORTED_MODULE_0__.pureComputed(() => {
        const index = _autopilot__WEBPACK_IMPORTED_MODULE_2__["default"].currentMode();
        return AutopilotVM.modeToText[index];
    });
    altitude = _autopilot__WEBPACK_IMPORTED_MODULE_2__["default"].modes.altitude.value.extend({
        apValidate: this.validateAltitude,
    });
    altitudeEnabled = _autopilot__WEBPACK_IMPORTED_MODULE_2__["default"].modes.altitude.enabled;
    vs = knockout__WEBPACK_IMPORTED_MODULE_0__.pureComputed({
        read: () => {
            if (_autopilot__WEBPACK_IMPORTED_MODULE_2__["default"].modes.vs.enabled()) {
                return this.formatVs(_autopilot__WEBPACK_IMPORTED_MODULE_2__["default"].modes.vs.value());
            }
            return "";
        },
        write: (val) => {
            const target = _autopilot__WEBPACK_IMPORTED_MODULE_2__["default"].modes.vs.value;
            const current = target();
    ...
    heading = knockout__WEBPACK_IMPORTED_MODULE_0__.pureComputed({
        read: () => {
            let str = _autopilot__WEBPACK_IMPORTED_MODULE_2__["default"].modes.heading.value().toString();
            while (str.length < 3)
                str = "0" + str;
            return str;
        },
        write: apValidate(_autopilot__WEBPACK_IMPORTED_MODULE_2__["default"].modes.heading.value, this.validateHeading),
    });
    headingEnabled = _autopilot__WEBPACK_IMPORTED_MODULE_2__["default"].modes.heading.enabled;
    speed = knockout__WEBPACK_IMPORTED_MODULE_0__.pureComputed({
        read: () => {
            const value = _autopilot__WEBPACK_IMPORTED_MODULE_2__["default"].modes.speed.value();
            return value.toFixed(_autopilot__WEBPACK_IMPORTED_MODULE_2__["default"].modes.speed.isMach() ? 2 : 0);
        },
        write: (val) => {
            const target = _autopilot__WEBPACK_IMPORTED_MODULE_2__["default"].modes.speed.value;
            const current = target();
            const newValue = _autopilot__WEBPACK_IMPORTED_MODULE_2__["default"].modes.speed.isMach()
    ...
    speedEnabled = _autopilot__WEBPACK_IMPORTED_MODULE_2__["default"].modes.speed.enabled;
    speedMode = knockout__WEBPACK_IMPORTED_MODULE_0__.pureComputed({
        read: () => {
            return _autopilot__WEBPACK_IMPORTED_MODULE_2__["default"].modes.speed.isMach() ? "mach" : "kias";
        },
        write: (val) => {
            _autopilot__WEBPACK_IMPORTED_MODULE_2__["default"].modes.speed.isMach(val === "mach");
        },
    });
    lat = _greatcircle__WEBPACK_IMPORTED_MODULE_1__["default"].latitude.extend({ apValidate: this.validateLat });
    lon = _greatcircle__WEBPACK_IMPORTED_MODULE_1__["default"].longitude.extend({ apValidate: this.validateLon });
    ...
    waypoint = knockout__WEBPACK_IMPORTED_MODULE_0__.pureComputed({
        ...
        write: (inputVal) => {
            ...
            const coord = (0,_getwaypoint__WEBPACK_IMPORTED_MODULE_4__["default"])(code);
            if (coord) {
                _greatcircle__WEBPACK_IMPORTED_MODULE_1__["default"].latitude(coord[0]);
                _greatcircle__WEBPACK_IMPORTED_MODULE_1__["default"].longitude(coord[1]);
                if (inputVal !== code)
                    this._waypoint(code);
                else
    ...
    constructor() {
        ...
        geofs.aircraft.Aircraft.change = (a, b, c, d) => {
            if (_shouldnthaveap__WEBPACK_IMPORTED_MODULE_5__["default"].includes(a)) {
                _autopilot__WEBPACK_IMPORTED_MODULE_2__["default"].on(false);
            }
...
/* harmony import */ var knockout__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! knockout */ "../node_modules/knockout/build/output/knockout-latest.js");
/* harmony import */ var knockout__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(knockout__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _autopilot__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../autopilot */ "./source/autopilot.ts");
/* harmony import */ var _apdisconnectsound__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./apdisconnectsound */ "./source/ui/apdisconnectsound.ts");
/* harmony import */ var _autopilot__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./autopilot */ "./source/ui/autopilot.ts");
/* harmony import */ var _enablekcas__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../enablekcas */ "./source/enablekcas.ts");
/* harmony import */ var _bugfixes_papi__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../bugfixes/papi */ "./source/bugfixes/papi.ts");
/* harmony import */ var _bugfixes_restrictions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../bugfixes/restrictions */ "./source/bugfixes/restrictions.ts");
/* harmony import */ var _ui_html__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ui.html */ "./source/ui/ui.html.ts");
/* harmony import */ var _ui_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./ui.css */ "./source/ui/ui.css.ts");
...
$("<style>").text(_ui_css__WEBPACK_IMPORTED_MODULE_8__["default"]).appendTo("head");
const $ap = $(".geofs-autopilot")
    .removeClass("geofs-autopilot")
    .prop("id", "Qantas94Heavy-ap")
    .on("keydown", stopImmediatePropagation)
    .html(_ui_html__WEBPACK_IMPORTED_MODULE_7__["default"]);
...
_autopilot__WEBPACK_IMPORTED_MODULE_1__["default"].on.subscribe(function (newValue) {
    if (!newValue && geofs.preferences.sound)
        _apdisconnectsound__WEBPACK_IMPORTED_MODULE_2__["default"].play();
});
(0,_bugfixes_papi__WEBPACK_IMPORTED_MODULE_5__["default"])();
(0,_bugfixes_restrictions__WEBPACK_IMPORTED_MODULE_6__["default"])();
(0,_enablekcas__WEBPACK_IMPORTED_MODULE_4__["default"])();
const viewModel = new _autopilot__WEBPACK_IMPORTED_MODULE_3__["default"]();
