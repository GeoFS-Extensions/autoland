...
const route = function (end) {
    const departure = _flight__WEBPACK_IMPORTED_MODULE_0__/* .flight.departure.coords */ .T.departure.coords();
    const arrival = _flight__WEBPACK_IMPORTED_MODULE_0__/* .flight.arrival.coords */ .T.arrival.coords();
    const start = _waypoints__WEBPACK_IMPORTED_MODULE_2__/* .waypoints.nextWaypoint */ .U.nextWaypoint() || 0;
    const route = _waypoints__WEBPACK_IMPORTED_MODULE_2__/* .waypoints.route */ .U.route();
    const pos = geofs.aircraft.instance.llaLocation;
    if (route.length === 0) {
        if (_flight__WEBPACK_IMPORTED_MODULE_0__/* .flight.departure.airport */ .T.departure.airport() && _flight__WEBPACK_IMPORTED_MODULE_0__/* .flight.arrival.airport */ .T.arrival.airport())
            return _utils__WEBPACK_IMPORTED_MODULE_1__/* .utils.getDistance */ .P.getDistance(departure[0], departure[1], arrival[0], arrival[1]);
        else
            return 0;
    }
    if (_waypoints__WEBPACK_IMPORTED_MODULE_2__/* .waypoints.nextWaypoint */ .U.nextWaypoint() === null) {
        if (_flight__WEBPACK_IMPORTED_MODULE_0__/* .flight.arrival.airport */ .T.arrival.airport() && pos[0])
            return _utils__WEBPACK_IMPORTED_MODULE_1__/* .utils.getDistance */ .P.getDistance(pos[0], pos[1], arrival[0], arrival[1]);
        if (pos[0])
            return _utils__WEBPACK_IMPORTED_MODULE_1__/* .utils.getDistance */ .P.getDistance(pos[0], pos[1], route[route.length - 1].lat(), route[route.length - 1].lon());
        return _utils__WEBPACK_IMPORTED_MODULE_1__/* .utils.getDistance */ .P.getDistance(route[0].lat(), route[0].lon(), route[route.length - 1].lat(), route[route.length - 1].lon());
    }
    else {
        let total = 0;
        ...
        if (end === route.length) {
            if (_flight__WEBPACK_IMPORTED_MODULE_0__/* .flight.arrival.airport */ .T.arrival.airport())
                total += _utils__WEBPACK_IMPORTED_MODULE_1__/* .utils.getDistance */ .P.getDistance(route[end - 1].lat(), route[end - 1].lon(), arrival[0], arrival[1]);
        }
        return total;
    }
};
...
const turn = function (angle) {
    ...
    const a = _utils__WEBPACK_IMPORTED_MODULE_1__/* .utils.toRadians */ .P.toRadians(angle);
...
const vnavEnabled = knockout__WEBPACK_IMPORTED_MODULE_0__.pureComputed({
    ...
    write: function (boolean) {
        ...
        if (!cruiseAlt())
            ...
            _nav_VNAV__WEBPACK_IMPORTED_MODULE_3__/* .vnav.timer */ .L.timer = setInterval(function () {
                _nav_VNAV__WEBPACK_IMPORTED_MODULE_3__/* .vnav.update */ .L.update();
            }, 5000);
            set(true);
        }
        else {
            clearInterval(_nav_VNAV__WEBPACK_IMPORTED_MODULE_3__/* .vnav.timer */ .L.timer);
            _nav_VNAV__WEBPACK_IMPORTED_MODULE_3__/* .vnav.timer */ .L.timer = null;
            set(false);
        }
    },
});
...
const _departureRwys = knockout__WEBPACK_IMPORTED_MODULE_0__.pureComputed(function () {
    ...
    return (0,_get__WEBPACK_IMPORTED_MODULE_1__/* .runway */ .Hs)(depArpt, depSID, true);
});
const _SIDs = knockout__WEBPACK_IMPORTED_MODULE_0__.pureComputed(function () {
    ...
    const depSID = departure.SID() ? departure.SID().name : undefined;
    return (0,_get__WEBPACK_IMPORTED_MODULE_1__/* .SID */ .x5)(depArpt, depRwy, depSID);
});
const departure = {
    airport: knockout__WEBPACK_IMPORTED_MODULE_0__.pureComputed({
        ...
        write: function (airport) {
            ...
            _nav_LNAV__WEBPACK_IMPORTED_MODULE_2__/* .lnav.update */ .d.update();
        },
    }),
...
const _arrivalRwys = knockout__WEBPACK_IMPORTED_MODULE_0__.pureComputed(function () {
    return (0,_get__WEBPACK_IMPORTED_MODULE_1__/* .runway */ .Hs)(arrival.airport());
});
const _STARs = knockout__WEBPACK_IMPORTED_MODULE_0__.pureComputed(function () {
    return (0,_get__WEBPACK_IMPORTED_MODULE_1__/* .SID */ .x5)(arrival.airport(), arrival.runway() ? arrival.runway().runway : false);
});
const arrival = {
    airport: knockout__WEBPACK_IMPORTED_MODULE_0__.pureComputed({
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "$5": () => (/* reexport safe */ _get_waypoint__WEBPACK_IMPORTED_MODULE_0__.$),
/* harmony export */   "x5": () => (/* reexport safe */ _get_SID__WEBPACK_IMPORTED_MODULE_2__.x),
...
const SID = (airport, runway, selectedSIDName) => {
    if (!airport)
        return [];
    const allSID = _data__WEBPACK_IMPORTED_MODULE_0__/* .data.SID */ .a.SID[airport] || [];
    const validSID = [];
    if (selectedSIDName) {
        if (!runway) {
...
const STAR = (airport, runway) => {
    if (!airport || !runway)
        return [];
    const allSTAR = _data__WEBPACK_IMPORTED_MODULE_0__/* .data.STAR */ .a.STAR[airport];
    const validSTAR = [];
...
const runway = (airport, selected, isDeparture) => {
    if (!airport)
        return [];
    const runways = _data__WEBPACK_IMPORTED_MODULE_0__/* .data.runways */ .a.runways[airport];
    const runwayArray = [];
    if (isDeparture) {
        if (selected) {
            (0,_SID__WEBPACK_IMPORTED_MODULE_1__/* .SID */ .x)(airport, undefined, selected)[0].availableRunways.forEach(function (rwy) {
                runwayArray.push({
                    runway: rwy,
                });
            });
...
const waypoint = (route, fix, index) => {
    ...
    if (coords)
        return coords;
    const navaid = _data__WEBPACK_IMPORTED_MODULE_0__/* .data.navaids */ .a.navaids[fix];
    if (navaid)
        return navaid;
    const list = _data__WEBPACK_IMPORTED_MODULE_0__/* .data.waypoints */ .a.waypoints[fix];
    if (list) {
        ...
        for (let i = 0; i < list.length; i++) {
            ...
            const relativeDist = _utils__WEBPACK_IMPORTED_MODULE_1__/* .utils.getDistance */ .P.getDistance(list[i][0], list[i][1], lat, lon);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ([_route_html__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z, _dep_arr_html__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z, _legs_html__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, _vnav_html__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z, _ils_html__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z, _progress_html__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z, _map_html__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z, _load_html__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z, _log_html__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .Z].join(""));
...
const update = function (other) {
    if (!geofs.pause && !(flight.recorder.playing || flight.recorder.paused)) {
        ...
        const time = _utils__WEBPACK_IMPORTED_MODULE_1__/* .utils.formatTime */ .P.formatTime(_utils__WEBPACK_IMPORTED_MODULE_1__/* .utils.timeCheck */ .P.timeCheck(h, m));
        other = other || "--";
...
const update = function () {
    if (_waypoints__WEBPACK_IMPORTED_MODULE_2__/* .waypoints.nextWaypoint */ .U.nextWaypoint() === null || !_flight__WEBPACK_IMPORTED_MODULE_1__/* .flight.arrival.airport */ .T.arrival.airport()) {
        clearInterval(timer);
        timer = null;
        return;
    }
    const d = _distance__WEBPACK_IMPORTED_MODULE_0__/* .distance.route */ .T.route(_waypoints__WEBPACK_IMPORTED_MODULE_2__/* .waypoints.nextWaypoint */ .U.nextWaypoint() + 1);
    if (d <= _distance__WEBPACK_IMPORTED_MODULE_0__/* .distance.turn */ .T.turn(60)) {
        _waypoints__WEBPACK_IMPORTED_MODULE_2__/* .waypoints.activateWaypoint */ .U.activateWaypoint(_waypoints__WEBPACK_IMPORTED_MODULE_2__/* .waypoints.nextWaypoint */ .U.nextWaypoint() + 1);
    }
    clearInterval(timer);
...
function getFlightParameters() {
    ...
    if (_flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.phase */ .T.phase() === 0) {
        ...
        if (_flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.spdControl */ .T.spdControl() && !belowStartAlt) {
            spd = profile[index][2];
    ...
    else if (_flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.phase */ .T.phase() === 2) {
        ...
        if (_flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.spdControl */ .T.spdControl() && !belowLastAlt) {
            spd = profile[index][2];
            vs = profile[index][3];
            switchSpeedMode(spd);
        }
...
function getVNAVProfile() {
    return (geofs.aircraft.instance.setup.fmcVnavProfile ||
        _vnav_profile__WEBPACK_IMPORTED_MODULE_5__/* .vnavProfile */ .l[geofs.aircraft.instance.id] ||
        _vnav_profile__WEBPACK_IMPORTED_MODULE_5__/* .vnavProfile.DEFAULT */ .l.DEFAULT);
}
...
const vnav = {
    timer: null,
    update: function () {
        if (!_flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.vnavEnabled */ .T.vnavEnabled())
            return;
        const route = _waypoints__WEBPACK_IMPORTED_MODULE_4__/* .waypoints.route */ .U.route();
        const params = getFlightParameters();
        const next = _waypoints__WEBPACK_IMPORTED_MODULE_4__/* .waypoints.nextWptAltRes */ .U.nextWptAltRes();
        const hasRestriction = next !== -1;
        let todDist = _flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.todDist */ .T.todDist();
        const cruiseAlt = _flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.cruiseAlt */ .T.cruiseAlt();
        const fieldElev = _flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.fieldElev */ .T.fieldElev();
        const todCalc = _flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.todCalc */ .T.todCalc();
        ...
        if (hasRestriction) {
            ...
            nextDist = _distance__WEBPACK_IMPORTED_MODULE_1__/* .distance.route */ .T.route(next + 1);
            targetDist = _distance__WEBPACK_IMPORTED_MODULE_1__/* .distance.target */ .T.target(deltaAlt);
            _debug__WEBPACK_IMPORTED_MODULE_0__/* .debug.log */ .f.log("targetAlt: " +
                targetAlt +
                ", deltaAlt: " +
                deltaAlt +
                ", nextDist: " +
        ...
        const lat2 = _flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.arrival.coords */ .T.arrival.coords()[0] || null;
        const lon2 = _flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.arrival.coords */ .T.arrival.coords()[1] || null;
        let flightDist;
        let valid = true;
        ...
        if (valid)
            flightDist = _distance__WEBPACK_IMPORTED_MODULE_1__/* .distance.route */ .T.route(route.length);
        else
            flightDist = _utils__WEBPACK_IMPORTED_MODULE_3__/* .utils.getDistance */ .P.getDistance(lat1, lon1, lat2, lon2);
        if (isNaN(flightDist))
            _flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.phase */ .T.phase(0);
        else if (flightDist < todDist)
            _flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.phase */ .T.phase(2);
        else if (Math.abs(cruiseAlt - currentAlt) <= 100)
            _flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.phase */ .T.phase(1);
        ...
        if (_flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.phase */ .T.phase() === 0) {
            if (hasRestriction) {
                const totalDist = _distance__WEBPACK_IMPORTED_MODULE_1__/* .distance.target */ .T.target(cruiseAlt - currentAlt) +
                    _distance__WEBPACK_IMPORTED_MODULE_1__/* .distance.target */ .T.target(targetAlt - cruiseAlt);
                _debug__WEBPACK_IMPORTED_MODULE_0__/* .debug.log */ .f.log("totalDist: " + totalDist);
                if (nextDist < totalDist) {
                    if (nextDist < targetDist)
                        vs = _utils__WEBPACK_IMPORTED_MODULE_3__/* .utils.getClimbrate */ .P.getClimbrate(deltaAlt, nextDist);
                    else
                        vs = params[1];
                    alt = targetAlt;
                }
        ...
        if (_flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.phase */ .T.phase() === 1 && (todCalc || !todDist)) {
            if (hasRestriction) {
                todDist = _distance__WEBPACK_IMPORTED_MODULE_1__/* .distance.route */ .T.route(route.length) - nextDist;
                todDist += _distance__WEBPACK_IMPORTED_MODULE_1__/* .distance.target */ .T.target(targetAlt - cruiseAlt);
            }
            else {
                todDist = _distance__WEBPACK_IMPORTED_MODULE_1__/* .distance.target */ .T.target(fieldElev - cruiseAlt);
            }
            todDist = Math.round(todDist);
            _flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.todDist */ .T.todDist(todDist);
            _debug__WEBPACK_IMPORTED_MODULE_0__/* .debug.log */ .f.log("TOD changed to " + todDist);
        }
        if (spd !== undefined)
...
const update = function () {
    const route = _waypoints__WEBPACK_IMPORTED_MODULE_4__/* .waypoints.route */ .U.route();
    const nextWaypoint = _waypoints__WEBPACK_IMPORTED_MODULE_4__/* .waypoints.nextWaypoint */ .U.nextWaypoint();
    const lat1 = geofs.aircraft.instance.llaLocation[0];
    const lon1 = geofs.aircraft.instance.llaLocation[1];
    const lat2 = _flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.arrival.coords */ .T.arrival.coords()[0];
    const lon2 = _flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.arrival.coords */ .T.arrival.coords()[1];
    const times = [[], [], [], [], []];
    ...
    if (valid)
        ...
        flightDist = _utils__WEBPACK_IMPORTED_MODULE_3__/* .utils.getDistance */ .P.getDistance(lat1, lon1, lat2, lon2);
    times[4] = _utils__WEBPACK_IMPORTED_MODULE_3__/* .utils.getETE */ .P.getETE(nextDist, false);
    if (!geofs.aircraft.instance.groundContact && _flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.arrival.airport */ .T.arrival.airport()) {
        times[0] = _utils__WEBPACK_IMPORTED_MODULE_3__/* .utils.getETE */ .P.getETE(flightDist, true);
        times[1] = _utils__WEBPACK_IMPORTED_MODULE_3__/* .utils.getETA */ .P.getETA(times[0][0], times[0][1]);
        if (flightDist - _flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.todDist */ .T.todDist() > 0) {
            times[2] = _utils__WEBPACK_IMPORTED_MODULE_3__/* .utils.getETE */ .P.getETE(flightDist - _flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.todDist */ .T.todDist(), false);
            times[3] = _utils__WEBPACK_IMPORTED_MODULE_3__/* .utils.getETA */ .P.getETA(times[2][0], times[2][1]);
        }
    }
...
const print = function (flightDist, nextDist, times) {
    ...
    for (let i = 0; i < times.length; i++) {
        formattedTimes.push(_utils__WEBPACK_IMPORTED_MODULE_3__/* .utils.formatTime */ .P.formatTime(times[i]));
    }
    if (flightDist < 10) {
    ...
    let todDist;
    if (_flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.todDist */ .T.todDist() && _flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.todDist */ .T.todDist() < flightDist)
        todDist = flightDist - _flight__WEBPACK_IMPORTED_MODULE_2__/* .flight.todDist */ .T.todDist();
    if (nextDist < 10) {
...
geofs.resetFlight = function () {
    if (confirm("Reset Flight?")) {
        oldReset();
        _log__WEBPACK_IMPORTED_MODULE_0__/* .log.update */ .c.update("Flight reset");
    }
};
const oldPause = geofs.togglePause;
geofs.togglePause = function () {
    if (!geofs.pause) {
        _log__WEBPACK_IMPORTED_MODULE_0__/* .log.update */ .c.update("Flight paused");
    }
    else {
        _log__WEBPACK_IMPORTED_MODULE_0__/* .log.update */ .c.update("Flight resumed");
    }
    oldPause();
};
...
controls.setters.setGear.set = function () {
    if (controls.gear.target === 0) {
        _log__WEBPACK_IMPORTED_MODULE_0__/* .log.update */ .c.update("Gear up");
    }
    else {
        _log__WEBPACK_IMPORTED_MODULE_0__/* .log.update */ .c.update("Gear down");
    }
    oldSetGear();
};
...
controls.setters.setFlapsUp.set = function () {
    ...
    if (geofs.aircraft.instance.setup.flapsPositions) {
        _log__WEBPACK_IMPORTED_MODULE_0__/* .log.update */ .c.update("Flaps raised to " + controls.flaps.positionTarget);
    }
    else
        _log__WEBPACK_IMPORTED_MODULE_0__/* .log.update */ .c.update("Flaps raised to " + controls.flaps.target);
};
const oldFlapsDown = controls.setters.setFlapsDown.set;
controls.setters.setFlapsDown.set = function () {
    oldFlapsDown();
    if (geofs.aircraft.instance.setup.flapsPositions) {
        _log__WEBPACK_IMPORTED_MODULE_0__/* .log.update */ .c.update("Flaps lowered to " + controls.flaps.positionTarget);
    }
    else
        _log__WEBPACK_IMPORTED_MODULE_0__/* .log.update */ .c.update("Flaps lowered to " + controls.flaps.target);
};
const oldAirbrakes = controls.setters.setAirbrakes.set;
controls.setters.setAirbrakes.set = function () {
    oldAirbrakes();
    _log__WEBPACK_IMPORTED_MODULE_0__/* .log.update */ .c.update(controls.airbrakes.target == 1
        ? "Activated airbrakes"
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ([
    _button_css__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z,
    _externaldist_css__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z,
    _modal_css__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z,
    _route_css__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z,
    _waypoints_css__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z,
    _dep_arr_css__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z,
    _legs_css__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z,
    _vnav_css__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z,
    _ils_css__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .Z,
    _progress_css__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z,
    _map_css__WEBPACK_IMPORTED_MODULE_10__/* ["default"] */ .Z,
    _load_css__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .Z,
    _log_css__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z,
].join(""));
...
class ViewModel {
    nextPhase() {
        const phase = _flight__WEBPACK_IMPORTED_MODULE_1__/* .flight.phase */ .T.phase();
        _flight__WEBPACK_IMPORTED_MODULE_1__/* .flight.phase */ .T.phase(phase === this.phaseToText.length - 1 ? 0 : phase + 1);
    }
    loadRoute() {
        _waypoints__WEBPACK_IMPORTED_MODULE_4__/* .waypoints.toRoute */ .U.toRoute(this.loadRouteText());
    ...
    modalWarning = _log__WEBPACK_IMPORTED_MODULE_3__/* .log.modalWarning */ .c.modalWarning;
    departureAirport = _flight__WEBPACK_IMPORTED_MODULE_1__/* .flight.departure.airport */ .T.departure.airport;
    arrivalAirport = _flight__WEBPACK_IMPORTED_MODULE_1__/* .flight.arrival.airport */ .T.arrival.airport;
    flightNumber = _flight__WEBPACK_IMPORTED_MODULE_1__/* .flight.number */ .T.number;
    route = _waypoints__WEBPACK_IMPORTED_MODULE_4__/* .waypoints.route */ .U.route;
    nextWaypoint = _waypoints__WEBPACK_IMPORTED_MODULE_4__/* .waypoints.nextWaypoint */ .U.nextWaypoint;
    saveWaypoints = _waypoints__WEBPACK_IMPORTED_MODULE_4__/* .waypoints.saveData */ .U.saveData;
    retrieveWaypoints = _waypoints__WEBPACK_IMPORTED_MODULE_4__/* .waypoints.loadFromSave */ .U.loadFromSave;
    addWaypoint = _waypoints__WEBPACK_IMPORTED_MODULE_4__/* .waypoints.addWaypoint */ .U.addWaypoint;
    activateWaypoint = _waypoints__WEBPACK_IMPORTED_MODULE_4__/* .waypoints.activateWaypoint */ .U.activateWaypoint;
    shiftWaypoint = _waypoints__WEBPACK_IMPORTED_MODULE_4__/* .waypoints.shiftWaypoint */ .U.shiftWaypoint;
    removeWaypoint = _waypoints__WEBPACK_IMPORTED_MODULE_4__/* .waypoints.removeWaypoint */ .U.removeWaypoint;
    fieldElev = _flight__WEBPACK_IMPORTED_MODULE_1__/* .flight.fieldElev */ .T.fieldElev;
    todDist = _flight__WEBPACK_IMPORTED_MODULE_1__/* .flight.todDist */ .T.todDist;
    todCalc = _flight__WEBPACK_IMPORTED_MODULE_1__/* .flight.todCalc */ .T.todCalc;
    departureRwyList = knockout__WEBPACK_IMPORTED_MODULE_0__.pureComputed(() => {
        if (this.SIDName())
            return (0,_get__WEBPACK_IMPORTED_MODULE_2__/* .SID */ .x5)(this.departureAirport(), this.departureRwyName(), this.SIDName()).availableRunways;
        else
            return (0,_get__WEBPACK_IMPORTED_MODULE_2__/* .runway */ .Hs)(this.departureAirport(), this.SIDName(), true);
    });
    departureRunway = _flight__WEBPACK_IMPORTED_MODULE_1__/* .flight.departure.runway */ .T.departure.runway;
    ...
    SIDList = knockout__WEBPACK_IMPORTED_MODULE_0__.pureComputed(() => {
        return (0,_get__WEBPACK_IMPORTED_MODULE_2__/* .SID */ .x5)(this.departureAirport(), this.departureRwyName());
    });
    SID = _flight__WEBPACK_IMPORTED_MODULE_1__/* .flight.departure.SID */ .T.departure.SID;
    ...
    arrivalRwyList = knockout__WEBPACK_IMPORTED_MODULE_0__.pureComputed(() => {
        return (0,_get__WEBPACK_IMPORTED_MODULE_2__/* .runway */ .Hs)(this.arrivalAirport());
    });
    arrivalRunway = _flight__WEBPACK_IMPORTED_MODULE_1__/* .flight.arrival.runway */ .T.arrival.runway;
    ...
    STARs = knockout__WEBPACK_IMPORTED_MODULE_0__.pureComputed(() => {
        return (0,_get__WEBPACK_IMPORTED_MODULE_2__/* .STAR */ .Js)(this.arrivalAirport(), this.arrivalRunwayName());
    });
    STAR = _flight__WEBPACK_IMPORTED_MODULE_1__/* .flight.arrival.STAR */ .T.arrival.STAR;
    ...
    vnavEnabled = _flight__WEBPACK_IMPORTED_MODULE_1__/* .flight.vnavEnabled */ .T.vnavEnabled;
    cruiseAlt = _flight__WEBPACK_IMPORTED_MODULE_1__/* .flight.cruiseAlt */ .T.cruiseAlt;
    spdControl = _flight__WEBPACK_IMPORTED_MODULE_1__/* .flight.spdControl */ .T.spdControl;
    phase = _flight__WEBPACK_IMPORTED_MODULE_1__/* .flight.phase */ .T.phase;
    phaseLocked = _flight__WEBPACK_IMPORTED_MODULE_1__/* .flight.phaseLocked */ .T.phaseLocked;
    phaseToText = ["climb", "cruise", "descent"];
    currentPhaseText = knockout__WEBPACK_IMPORTED_MODULE_0__.pureComputed(() => {
        return this.phaseToText[_flight__WEBPACK_IMPORTED_MODULE_1__/* .flight.phase */ .T.phase()];
    });
    progInfo = _nav_progress__WEBPACK_IMPORTED_MODULE_5__/* .progress.info */ .Y.info;
    ...
    generateRoute = knockout__WEBPACK_IMPORTED_MODULE_0__.pureComputed({
        ...
        write: (isGenerate) => {
            const generatedRoute = isGenerate ? _waypoints__WEBPACK_IMPORTED_MODULE_4__/* .waypoints.toRouteString */ .U.toRouteString() : undefined;
            this.generatedRouteText(generatedRoute);
        },
    });
    logData = _log__WEBPACK_IMPORTED_MODULE_3__/* .log.data */ .c.data;
    removeLogData = _log__WEBPACK_IMPORTED_MODULE_3__/* .log.removeData */ .c.removeData;
}
...
_position__WEBPACK_IMPORTED_MODULE_2__/* .positioningFMC.then */ .Z.then(loadFMC);
function loadFMC() {
    ...
    const vm = new _ViewModel__WEBPACK_IMPORTED_MODULE_1__/* .ViewModel */ .j();
    ...
    _waypoints__WEBPACK_IMPORTED_MODULE_4__/* .waypoints.addWaypoint */ .U.addWaypoint();
    ...
    _nav_progress__WEBPACK_IMPORTED_MODULE_5__/* .progress.update */ .Y.update();
    _log__WEBPACK_IMPORTED_MODULE_3__/* .log.update */ .c.update();
    _log__WEBPACK_IMPORTED_MODULE_3__/* .log.speed */ .c.speed();
...
const positioningFMC = new Promise(function (resolve) {
    $("<style>").addClass("fmc-stylesheet").text(_style_main__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z).appendTo("head");
    $(_html_modal_html__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z).appendTo("body");
    $(_html_tab_contents_main__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z).appendTo(_elements__WEBPACK_IMPORTED_MODULE_0__.E.container.modalContent);
    $(_html_button_html__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z).insertAfter('button.geofs-f-standard-ui[data-toggle-panel=".geofs-map-list"]');
    $(_html_externaldist_html__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z).appendTo(".geofs-ui-bottom");
    resolve();
});
...
function getGroundSpeed() {
    ...
    _debug__WEBPACK_IMPORTED_MODULE_0__/* .debug.log */ .f.log("tas: " + tas + ", vs: " + vs);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "l": () => (/* binding */ vnavProfile)
/* harmony export */ });
const vnavProfile = {
    "4": {
        climb: [
...
class Waypoint {
    ...
    wpt = knockout__WEBPACK_IMPORTED_MODULE_0__.pureComputed({
        ...
        write: (val) => {
            this._wpt(val);
            const coords = (0,_get__WEBPACK_IMPORTED_MODULE_2__/* .waypoint */ .$5)(route, val, getIndex(this));
...
function getInfoFromPrev(self) {
    ...
    if (index === 0 || index === nextWaypoint()) {
        ...
        distance = _utils__WEBPACK_IMPORTED_MODULE_5__/* .utils.getDistance */ .P.getDistance(pos[0], pos[1], self.lat(), self.lon());
        bearing = _utils__WEBPACK_IMPORTED_MODULE_5__/* .utils.getBearing */ .P.getBearing(pos[0], pos[1], self.lat(), self.lon());
    }
    else if (index) {
        const prev = route()[index - 1];
        distance = _utils__WEBPACK_IMPORTED_MODULE_5__/* .utils.getDistance */ .P.getDistance(prev.lat(), prev.lon(), self.lat(), self.lon());
        bearing = _utils__WEBPACK_IMPORTED_MODULE_5__/* .utils.getBearing */ .P.getBearing(prev.lat(), prev.lon(), self.lat(), self.lon());
    }
...
function makeFixesArray() {
    const result = [];
    const departureVal = _flight__WEBPACK_IMPORTED_MODULE_3__/* .flight.departure.airport */ .T.departure.airport();
    if (departureVal)
        result.push(departureVal);
    route().forEach((rte) => {
        result.push(rte.wpt());
    });
    const arrivalVal = _flight__WEBPACK_IMPORTED_MODULE_3__/* .flight.arrival.airport */ .T.arrival.airport();
    if (arrivalVal)
...
function toRouteString() {
    ...
    return JSON.stringify([
        _flight__WEBPACK_IMPORTED_MODULE_3__/* .flight.departure.airport */ .T.departure.airport() || "",
        _flight__WEBPACK_IMPORTED_MODULE_3__/* .flight.arrival.airport */ .T.arrival.airport() || "",
        _flight__WEBPACK_IMPORTED_MODULE_3__/* .flight.number */ .T.number() || "",
        normalizedRoute,
    ]);
}
...
function toRoute(s) {
    if (!s) {
        _log__WEBPACK_IMPORTED_MODULE_4__/* .log.warn */ .c.warn("Please enter waypoints separated by spaces or a generated route");
        return;
    }
    s = s.trim();
    if (s.indexOf('["') === 0) {
    ...
    if (!isWaypoints) {
        _log__WEBPACK_IMPORTED_MODULE_4__/* .log.warn */ .c.warn("Invalid Waypoints Input");
        return;
    }
    removeWaypoint(true);
    if (departure) {
        const wpt = str[0];
        _flight__WEBPACK_IMPORTED_MODULE_3__/* .flight.departure.airport */ .T.departure.airport(wpt);
        a = 1;
    }
    else {
        a = 0;
        _flight__WEBPACK_IMPORTED_MODULE_3__/* .flight.departure.airport */ .T.departure.airport(undefined);
    }
    if (arrival) {
        const wpt = str[str.length - 1];
        _flight__WEBPACK_IMPORTED_MODULE_3__/* .flight.arrival.airport */ .T.arrival.airport(wpt);
        b = 1;
    }
    else {
        b = 0;
        _flight__WEBPACK_IMPORTED_MODULE_3__/* .flight.arrival.airport */ .T.arrival.airport(undefined);
    }
...
function addWaypoint() {
    ...
    _debug__WEBPACK_IMPORTED_MODULE_1__/* .debug.stopPropagation */ .f.stopPropagation();
}
...
function activateWaypoint(n) {
    if (n !== false && nextWaypoint() !== n) {
        if (n < route().length) {
            ...
            _debug__WEBPACK_IMPORTED_MODULE_1__/* .debug.log */ .f.log("Waypoint # " + Number(Number(n) + 1) + " activated | index: " + n);
        }
        else {
            if (_flight__WEBPACK_IMPORTED_MODULE_3__/* .flight.arrival.coords */ .T.arrival.coords()[1]) {
                gc.latitude(_flight__WEBPACK_IMPORTED_MODULE_3__/* .flight.arrival.coords */ .T.arrival.coords()[1]);
                gc.longitude(_flight__WEBPACK_IMPORTED_MODULE_3__/* .flight.arrival.coords */ .T.arrival.coords()[2]);
            }
            nextWaypoint(null);
        }
    }
    ...
    _nav_LNAV__WEBPACK_IMPORTED_MODULE_6__/* .lnav.update */ .d.update();
    _nav_progress__WEBPACK_IMPORTED_MODULE_7__/* .progress.update */ .Y.update();
}
...
function saveData() {
    if (route().length < 1 || !route()[0].wpt()) {
        _log__WEBPACK_IMPORTED_MODULE_4__/* .log.warn */ .c.warn("There is no route to save");
    }
    else {
...
function loadFromSave(arg) {
    ...
    if (arr) {
        ...
        _flight__WEBPACK_IMPORTED_MODULE_3__/* .flight.departure.airport */ .T.departure.airport(arr[0]);
        _flight__WEBPACK_IMPORTED_MODULE_3__/* .flight.arrival.airport */ .T.arrival.airport(arr[1]);
        _flight__WEBPACK_IMPORTED_MODULE_3__/* .flight.number */ .T.number(arr[2]);
        for (let i = 0; i < rte.length; i++) {
            addWaypoint();
            if (rte[i][0])
                route()[i].wpt(rte[i][0]);
        ...
        _log__WEBPACK_IMPORTED_MODULE_4__/* .log.warn */ .c.warn("There is no saved route or the browser's cache was cleared.");
}
function shiftWaypoint(oldIndex, value) {
    _debug__WEBPACK_IMPORTED_MODULE_1__/* .debug.log */ .f.log(`Waypoint #${oldIndex + 1} (index=${oldIndex}) shifted ${value}`);
...
const waypoints = {
    ...
    getCoords: _get__WEBPACK_IMPORTED_MODULE_2__/* .waypoint */ .$5,
};
