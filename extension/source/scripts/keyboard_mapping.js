...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
    (0,_addKeybind__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("Toggle Autopilot", () => {
        controls.setters.toggleAutoPilot.set();
    }, (0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)()["Toggle Autopilot"] || {
        ctrlKey: false,
        shiftKey: false,
        altKey: false,
        code: "KeyA",
    });
    (0,_addKeybind__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("Bank left", (event) => {
        controls.states.left = !0;
        event.returnValue = !1;
        controls.keyboard.override = !0;
    }, (0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)()["Bank left"] || {
        ctrlKey: false,
        shiftKey: false,
        altKey: false,
        code: "ArrowLeft",
    });
    (0,_addKeybind__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("Bank right", (event) => {
        controls.states.right = !0;
        event.returnValue = !1;
        controls.keyboard.override = !0;
    }, (0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)()["Bank right"] || {
        ctrlKey: false,
        shiftKey: false,
        altKey: false,
        code: "ArrowRight",
    });
    (0,_addKeybind__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("Pitch down", (event) => {
        controls.states.up = !0;
        event.returnValue = !1;
        controls.keyboard.override = !0;
    }, (0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)()["Pitch down"] || {
        ctrlKey: false,
        shiftKey: false,
        altKey: false,
        code: "ArrowUp",
    });
    (0,_addKeybind__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("Pitch up", (event) => {
        controls.states.down = !0;
        event.returnValue = !1;
        controls.keyboard.override = !0;
    }, (0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)()["Pitch up"] || {
        ctrlKey: false,
        shiftKey: false,
        altKey: false,
        code: "ArrowDown",
    });
    (0,_addKeybind__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("Steer left", (event) => {
        controls.states.rudderLeft = !0;
        event.returnValue = !1;
        controls.keyboard.overrideRudder = !0;
    }, (0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)()["Steer left"] || {
        ctrlKey: false,
        shiftKey: false,
        altKey: false,
        code: "Comma",
    });
    (0,_addKeybind__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("Steer right", (event) => {
        controls.states.rudderRight = !0;
        event.returnValue = !1;
        controls.keyboard.overrideRudder = !0;
    }, (0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)()["Steer right"] || {
        ctrlKey: false,
        shiftKey: false,
        altKey: false,
        code: "Period",
    });
    (0,_addKeybind__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("Increase throttle", (event) => {
        controls.states.increaseThrottle = !0;
        event.returnValue = !1;
    }, (0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)()["Increase throttle"] || {
        ctrlKey: false,
        shiftKey: false,
        altKey: false,
        code: "NumpadAdd",
    });
    (0,_addKeybind__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(`${""}`, (event) => {
        controls.states.increaseThrottle = !0;
        event.returnValue = !1;
    }, {
        ctrlKey: false,
    ...
    (0,_addKeybind__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("Decrease throttle", (event) => {
        controls.states.increaseThrottle = !0;
        event.returnValue = !1;
    }, (0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)()["Decrease throttle"] || {
        ctrlKey: false,
        shiftKey: false,
        altKey: false,
        code: "NumpadSubtract",
    ...
    (0,_addKeybind__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("Brakes", () => {
        controls.setters.setBrakes.set();
    }, (0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)()["Brakes"] || {
        ctrlKey: false,
        shiftKey: false,
        altKey: false,
        code: "Space",
    });
    (0,_addKeybind__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("Parking brake", () => {
        controls.setters.toggleParkingBrake.set();
    }, (0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)()["Parking brake"] || {
        ctrlKey: false,
        shiftKey: false,
        altKey: false,
        code: "Semicolon",
    });
    (0,_addKeybind__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("Engine switch (on/off)", () => {
        geofs.aircraft.instance.engine.on
            ? geofs.aircraft.instance.stopEngine()
            : geofs.aircraft.instance.startEngine();
    }, (0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)()["Engine switch (on/off)"] || {
        ctrlKey: false,
        altKey: false,
        shiftKey: false,
        code: "KeyE",
    });
    (0,_addKeybind__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("Gear toggle (up/down)", () => {
        controls.setters.setGear.set();
    }, (0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)()["Gear toggle (up/down)"] || {
        ctrlKey: false,
        altKey: false,
        shiftKey: false,
        code: "KeyG",
    });
    (0,_addKeybind__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("Lower flaps", () => {
        controls.setters.setFlapsDown.set();
    }, (0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)()["Lower flaps"] || {
        ctrlKey: false,
        altKey: false,
        shiftKey: false,
        code: "BracketLeft",
    });
    (0,_addKeybind__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("Raise flaps", () => {
        controls.setters.setFlapsUp.set();
    }, (0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)()["Raise flaps"] || {
        ctrlKey: false,
        altKey: false,
        shiftKey: false,
        code: "BracketRight",
    });
    (0,_addKeybind__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("Airbrake toggle (on/off)", () => {
        controls.setters.setAirbrakes.set();
    }, (0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)()["Airbrake toggle (on/off)"] || {
        ctrlKey: false,
        altKey: false,
        shiftKey: false,
        code: "KeyB",
    });
    (0,_addKeybind__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("Optional Animated Part toggle (on/off)", () => {
        controls.setters.setOptionalAnimatedPart.set();
    }, (0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)()["Optional Animated Part toggle (on/off)"] || {
        ctrlKey: false,
        altKey: false,
        shiftKey: false,
        code: "KeyX",
    });
    (0,_addKeybind__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("Elevator trim down", () => {
        controls.setters.setElevatorTrimDown.set();
    }, (0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)()["Elevator trim down"] || {
        ctrlKey: false,
        altKey: false,
        shiftKey: false,
        code: "End",
    });
    (0,_addKeybind__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("Elevator trim up", () => {
        controls.setters.setElevatorTrimUp.set();
    }, (0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)()["Elevator trim up"] || {
        ctrlKey: false,
        altKey: false,
        shiftKey: false,
        code: "Home",
    });
    (0,_addKeybind__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("Elevator trim neutral", () => {
        controls.setters.setElevatorTrimNeutral.set();
    }, (0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)()["Elevator trim neutral"] || {
        ctrlKey: false,
        altKey: false,
        shiftKey: false,
        code: "Delete",
    });
    (0,_addKeybind__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("", () => {
        controls.recenter();
    }, {
        ctrlKey: false,
        shiftKey: false,
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(label, callback, defaultKeybind) {
    if (label !== "" && addedKeybindsLabels.includes(label)) {
        _keyboardMapping__WEBPACK_IMPORTED_MODULE_1__/* ["default"].notifySubscribers */ .Z.notifySubscribers();
        return;
    }
    if (label !== "") {
        (0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)({ ...(0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)(), [label]: defaultKeybind });
        addedKeybindsLabels.push(label);
    }
    const oldKeyDown = (0,_keyDown__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)();
    (0,_keyDown__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)((event) => {
        const keybind = (0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)()[label] || defaultKeybind;
...
class ViewModel {
    ...
    constructor() {
        ...
        _keyboardMapping__WEBPACK_IMPORTED_MODULE_0__/* ["default"].subscribe */ .Z.subscribe(this.updateKeybindInputs);
        this.updateKeybindInputs((0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)());
    }
    reset = () => {
    ...
    stringFromKeybind = (keybind) => {
        ...
        str +=
            keybind.code.includes("Control") ||
                ...
                ? ""
                : _static_keyboardLayout__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z[keybind.code] || keybind.code;
        return str;
    };
    addKeybind = (key) => {
    ...
    handleKeyDown = (e) => {
        if ($(e.target).hasClass("keyboard-mapping-key-detecting")) {
            ...
            e.stopPropagation();
            if (e.code !== "Escape") {
                (0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)({
                    ...(0,_keyboardMapping__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(),
                    [$(e.target).attr("name")]: {
                        ctrlKey: e.ctrlKey,
                        shiftKey: e.shiftKey,
...
new _ViewModel__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z();
